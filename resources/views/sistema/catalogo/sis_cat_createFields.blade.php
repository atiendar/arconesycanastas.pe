<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::select('input', config('opcionesSelect.select_input'), null, ['class' => 'form-control select2' . ($errors->has('input') ? ' is-invalid' : ''), 'placeholder' => __('')]) !!}
    </div>
...
<div class="row">
  <div class="form-group col-sm btn-sm">
    ...
    <div class="input-group">
      ...
      {!! Form::text('value', null, ['class' => 'form-control' . ($errors->has('value') ? ' is-invalid' : ''), 'maxlength' => 150, 'placeholder' => __('Value')]) !!}
    </div>
